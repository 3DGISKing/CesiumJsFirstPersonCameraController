defineSuite([
    ...
    it('creates expected instance from raw assignment and construction', function() {
        ...
        expect(plane.distanceDisplayCondition.getValue()).toEqual(options.distanceDisplayCondition);
    });
    ...
    it('raises definitionChanged when a property is assigned or modified', function() {
        ...
        testDefinitionChanged(property, 'plane', new Plane(Cartesian3.UNIT_X, 0.0), new Plane(Cartesian3.UNIT_Z, 1.0));
        testDefinitionChanged(property, 'dimensions', new Cartesian2(0.0, 0.0), new Cartesian2(1.0, 1.0));
